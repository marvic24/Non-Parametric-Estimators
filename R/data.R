...
#' @keywords datasets
#'
#' @title The dataset called \code{data} contains a single environment called
#'   etf_env, which includes daily \code{OHLC} time series data for a portfolio
#'   of symbols.  All the prices are already adjusted.
#'
#' @description
...
#' }
#'
#' @usage data(data)  # not required - data is lazy load
#'
#' @examples
